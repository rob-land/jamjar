#!/usr/bin/env bash
# build-all.sh — build Jamjar flatpak bundles for x86_64 and aarch64.
#
# Usage:
...
#
# Outputs:
#   jamjar-x86_64.flatpak
#   jamjar-aarch64.flatpak
...
if $INSTALL; then
    bundle="jamjar-${HOST_ARCH}.flatpak"
    if [[ -f "$bundle" ]]; then
        echo
